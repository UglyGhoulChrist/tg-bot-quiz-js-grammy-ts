...
export const listQuiz: IQuiz[] = [
    ...
    },
    {
        ...
        correct: 0,
        explanation: "Унарный плюс ('+') приводит операнд к числу. 'true' - это '1', а 'false' - '0'. Строка 'John' - это истинное значение. Мы спрашиваем, является ли это значение ложным? Ответ: 'false'."
    },
    {
        id: 5,
    ...
    },
    {
        ...
        correct: 3,
        explanation: "Метод 'colorChange' является статическим. Такие методы не имеют доступа к экземплярам класса. Так как 'freddie' - это экземпляр, статический метод в нем не доступен. Поэтому выбрасывается исключение 'TypeError'."
    },
    {
        id: 8,
    ...
    },
    {
        ...
        correct: 0,
        explanation: "В 'JavaScript' такое возможно, т.к. функции в 'JS' - это тоже объекты. Точнее, функция — это специальный тип объекта, который можно вызывать (такой объект имеет внутренний слот 'callable'). Кроме того, функция — это объект со свойствами, вызывать которые нельзя, поскольку они не являются функциями."
    },
    {
        id: 10,
    ...
    },
    {
        ...
        correct: 2,
        explanation: "Оператор распространения или расширения (spread, '...') возвращает массив с аргументами, переданными функции. Массив - это объект, поэтому выражение 'typeof args' возвращает 'object'."
    },
    {
        id: 17,
        ...
        correct: 2,
        explanation: "''use strict'', среди прочего, позволяет предотвратить случайное объявление глобальных переменных. Мы не объявляли переменную 'age', поэтому (в строгом режиме) выбрасывается исключение 'ReferenceError'. В нестрогом режиме ошибки не возникнет, а переменная 'age' станет свойством глобального объекта 'window'."
    },
    {
        id: 18,
        ...
        correct: 0,
        explanation: "Функция 'eval' выполняет код, переданный ей в виде строки. Если это выражение (как в данном случае), то оно вычисляется (оценивается). Выражение '10 * 10 + 5' возвращает число '105'. Использовать 'eval' не рекомендуется по причинам безопасности."
    },
    {
        id: 19,
        question: "var num = 8\nvar num = 10\n\nconsole.log(num)",
        ...
        correct: 1,
        explanation: "С помощью ключевого слова 'var' можно определять любое количество одноименных переменных. Переменная будет хранить последнее присвоенное ей значение. Однако, такой трюк нельзя проделать с 'let' и 'const', т.к. переменные, объявленные с помощью этих ключевых слов, имеют блочную область видимости."
    },
    {
        id: 20,
        ...
        correct: 2,
        explanation: "Ключи объектов (кроме 'Symbol') являются строками, даже если заданы не в виде строк (например, индексы в массиве). Поэтому выражение 'obj.hasOwnProperty('1')' также возвращает 'true'. Однако, это не работает с 'Set'. Значение '1' отсутствует в 'set': 'set.has('1')' возвращает 'false', а 'set.has(1)' - 'true'."
    },
    {
        id: 21,
    ...
    },
    {
        ...
        correct: 2,
        explanation: "Оператор 'continue' пропускает текущую итерацию (цикл), если условие удовлетворяется (является истинным)."
    },
    {
        id: 23,
        ...
        correct: 0,
        explanation: "'String' - это встроенный конструктор, к которому можно добавлять новые свойства. Мы добавили метод 'giveMePizza' к его прототипу. Строки-примитивы автоматически конвертируются (преобразуются) в строки-объекты (благодаря объектной обертке). Поэтому все строки (объекты) имеют доступ к указанному методу."
    },
    {
        id: 24,
        question: "const a = {}\nconst b = { key: 'b' }\nconst c = { key: 'c' }\n\na[b] = 123\na[c] = 456\n\nconsole.log(a[b])",
    ...
    },
    {
        ...
        correct: 3,
        explanation: "В обоих случаях мы передаем объект, на который будет указывать 'this'. Но метод 'call' выполняется сразу, а метод 'bind' возвращает копию функции с привязанным контекстом. Эту функцию следует вызывать отдельно или можно сделать так: 'sayHi.bind(person, 30)()'."
    },
    {
        id: 28,
    ...
    },
    {
        ...
        correct: 1,
        explanation: "Выражение 'typeof 1' возвращает 'number'. Выражение 'typeof number' возвращает 'string'."
    },
    {
        id: 30,
        ...
        correct: 2,
        explanation: "Когда в массив добавляется значение, которое выходит за пределы длины массива, 'JavaScript' создает 'пустые ячейки'. На самом деле они имеют значение 'undefined', но в консоль выводятся как '[1, 2, 3, 7 x empty, 11]' (зависит от среды выполнения кода, от браузера)."
    },
    {
        id: 31,
        question: "(() => {\n  let x, y\n  try {\n    throw new Error()\n  } catch (x) {\n    (x = 1), (y = 2)\n    console.log(x)\n  }\n  console.log(x)\n  console.log(y)\n})()",
    ...
    },
    {
        ...
        correct: 2,
        explanation: "'[1, 2]' - начальное значение переменной 'acc'. После первого прохода 'acc' равняется '[1, 2]', а 'cur' - '[0, 1]'. После конкатенации (объединения) 'acc' равняется '[1, 2, 0, 1]', а 'cur' - '[2, 3]'. После их объединения, мы получаем '[1, 2, 0, 1, 2, 3]'."
    },
    {
        id: 33,
    ...
    },
    {
        ...
        correct: 0,
        explanation: "Строка является итерируемой (перебираемой) сущностью. Оператор распространения или расширения (spread, '...') преобразует строку в массив, состоящий из символов этой строки."
    },
    {
        id: 35,
    ...
    },
    {
        ...
        correct: 3,
        explanation: "Сначала мы объявляем переменную 'person' со значением объекта, содержащего свойство 'name'. Затем мы объявляем переменную 'members'. Мы делаем первый элемент этого массива равным '[person]'. Объекты взаимодействуют посредством ссылок при установке их равными друг другу. Когда мы назначаем ссылку из одной переменной в другую, создается копия этой ссылки (обратите внимание, что у этих переменных не одинаковые ссылки). Затем мы присваиваем переменной 'person' значение 'null'. Мы изменили только значение 'person', а не первый элемент массива, поскольку этот элемент имеет другую (скопированную) ссылку на объект. Первый элемент в 'members' по-прежнему содержит ссылку на исходный объект. Когда мы выводим в консоль массив 'members', первый элемент этого массива содержит значение объекта, который и выводится в консоль."
    },
    {
        id: 38,
    ...
    },
    {
        ...
        correct: 2,
        explanation: "Функция 'parseInt' проверяет, являются ли символы в строке допустимыми с точки зрения используемой системы счисления (второй необязательный аргумент). Как только встречается недопустимый символ, синтаксический анализ строки прекращается и последующие символы игнорируются. '*' является недопустимым числом. Поэтому 'parseInt' прекращает разбор строки и возвращает '7'."
    },
    {
        id: 41,
    ...
    },
    {
        ...
        correct: 3,
        explanation: "С помощью оператора 'throw' мы можем создавать собственные ошибки. Другими словами, с помощью этого оператора мы можем генерировать пользовательские исключения. Исключением может быть строка, число, логическое значение или объект. В данном случае, исключением является строка 'Всем привет!'. С помощью оператора 'catch' мы можем указать, что делать, если в блоке 'try' возникла Error. Исключение - 'Всем привет!'. 'error' равняется этой строке. Это приводит к 'Error: Всем привет!'."
    },
    {
        id: 43,
        ...
        correct: 1,
        explanation: "Когда возвращается свойство, его значение равняется возвращаемому значению, а не значению, установленному в функции-конструкторе. Мы возвращаем строку 'Maserati', поэтому значением 'myCar.make' является 'Maserati'."
    },
    {
        id: 44,
    ...
    },
    {
        ...
        correct: 3,
        explanation: "'Set' является коллекцией уникальных значений. Мы передаем в 'new Set()' массив '[1, 1, 2, 3, 4]' с повторяющимся значением '1'. Поскольку в 'set' не может быть двух одинаковых значений, одно из них удаляется. Это приводит к '{ 1, 2, 3, 4 }'."
    },
    {
        id: 47,
        ...
        correct: 2,
        explanation: "Импортируемый модуль доступен только для чтения: мы не можем его изменять. Это можно сделать только перед экспортом. Когда мы пытаемся увеличить значение переменной 'myCounter', возникает Error 'myCounter доступен только для чтения и не может быть изменен'."
    },
    {
        id: 48,
    ...
    },
    {
        ...
        correct: 1,
        explanation: "Оператор распространения или расширения (spread, '...') позволяет объединять объекты - создавать копии пар ключ/значение одного объекта и добавлять их в другой объект. В данном случае мы создаем копию объекта 'user' и добавляем ее в объект 'admin'. Объект 'admin' содержит скопированные пары ключ/значение, что приводит к '{ admin: true, name: 'John', age: 30 }'."
    },
    {
        id: 51,
    ...
    },
    {
        ...
        correct: 0,
        explanation: "С помощью оператора '+' мы можем объединять строки. Это называется конкатенацией. В данном случае, мы объединяем строку '📱' со строкой '💻', что приводит к '📱💻'."
    },
    {
        id: 60,
    ...
    },
    {
        ...
        correct: 2,
        explanation: "Асинхронная функция всегда возвращает промис. 'await' ожидает разрешения промиса: промис разрешается, когда мы вызываем 'getData()', чтобы присвоить его переменной 'data'. Если бы мы хотели получить доступ к разрешенному значению 'Я сделал это!', мы могли бы использовать метод 'then' для 'data': 'data.then(res => console.log(res))'. Тогда бы мы получили 'Я сделал это!'."
    },
    {
        id: 63,
    ...
    },
    {
        ...
        correct: 0,
        explanation: "С помощью цикла 'for-in' мы перебираем перечисляемые свойства объекта. В массиве перечисляемые свойства являются 'ключами' элементов массива, которые фактически являются их индексами. Вы можете представить массив как: '{0: '☕', 1: '💻', 2: '🍷', 3: '🍫'}', где ключи - перечисляемые свойства. '0 1 2 3' выводится в консоль.\nС помощью цикла 'for-of' мы перебираем значения итерируемых сущностей (сущностей, поддающихся перебору). Массив является итерируемой сущностью. Когда мы выполняем итерацию по массиву, переменная 'item' равняется итерируемому элементу, ''☕' '💻' '🍷' '🍫'' выводится в консоль."
    },
    {
        id: 68,
        ...
        correct: 2,
        explanation: "Элементами массива могут быть любые типы данных. Числа, строки, объекты, другие массивы, 'null', логические значения, 'undefined', а также даты, функции и выражения. Элемент будет равен возвращаемому значению. Выражение '1 + 2' возвращает '3', '1 * 2' - '2', а '1 / 2' - '0.5'."
    },
    {
        id: 69,
        ...
        correct: 1,
        explanation: "По умолчанию аргументы функции имеют значение 'undefined', если значение не было передано при вызове функции или присвоено по умолчанию. В данном случае мы не передаем значения для аргумента 'name'. 'name' равняется 'undefined'. В 'ES6' мы можем перезаписывать 'undefined' значениями по умолчанию. Например: 'function sayHi(name = 'John') { ... }'. В данном случае, если мы не передали значение или передали 'undefined', аргумент 'name' будет иметь значение 'John'."
    },
    {
        id: 70,
    ...
    },
    {
        ...
        correct: 1,
        explanation: "Чтобы получить символ по определенному индексу из строки, мы можем использовать скобочную нотацию. Первый символ в строке имеет индекс '0', второй - индекс '1' и т.д. В данном случае мы хотим получить элемент с индексом '0', символ 'Я', который и выводится в консоль. Альтернативой получения символа по индексу является метод 'charAt'."
    },
    {
        id: 75,
    ...
    },
    {
        ...
        correct: 2,
        explanation: "Классы являются синтаксическим сахаром для функций-конструкторов. Эквивалентом класса 'Person' в качестве функции-конструктора будет 'function Person() { this.name = name }'. Вызов функции-конструктора с ключевым словом 'new' приводит к созданию нового экземпляра объекта 'Person'. Выражение 'typeof member' возвращает 'object'."
    },
    {
        id: 78,
        ...
        correct: 3,
        explanation: "Метод 'push' возвращает длину нового массива, а не сам массив. Устанавливая 'newList' равным '[1, 2, 3].push(4)', мы устанавливаем 'newList' равным '4'. Затем мы пытаемся использовать метод 'push' для 'newList'. Поскольку 'newList' является числом '4', мы не можем использовать 'push' - выбрасывается исключение 'TypeError'."
    },
    {
        id: 79,
        ...
        correct: 3,
        explanation: "Обычные функции, такие как 'giveMePizza', имеют свойство 'prototype', которое является объектом (прототипом объекта) со свойством 'constructor'. Однако стрелочные функции, такие как 'giveMeChocolate', не имеют прототипа. Поэтому при попытке получить доступ к 'giveMeChocolate.prototype' возвращается 'undefined'."
    },
    {
        id: 80,
    ...
    },
    {
        ...
        correct: 3,
        explanation: "'...args' - это прочие параметры (оператор rest). Значение прочих параметров - это массив, содержащий неиспользованные аргументы и в этой связи передаваемый последним. В приведенном примере 'rest' является вторым аргументом. Это приводит к синтаксической ошибке.\n'''js\nfunction getItems(fruitList, favoriteFruit, ...args) {\n  return [...fruitList, ...args, favoriteFruit]\n}\ngetItems(['banana', 'apple'], 'pear', 'orange')\n'''\nДанный код работает, как ожидается, и возвращает массив '[ 'banana', 'apple', 'orange', 'pear' ]'."
    },
    {
        id: 82,
    ...
    },
    {
        ...
        correct: 1,
        explanation: "Мы можем установить классы равными другим классам/функциям-конструкторам. В данном случае мы устанавливаем класс 'Person' равным классу 'AnotherPerson'. Свойство 'name' этого конструктора имеет значение 'Jane', поэтому свойство 'name' для нового экземпляра класса 'Person' 'member' - это также 'Jane'."
    },
    {
        id: 84,
    ...
    },
    {
        ...
        correct: 0,
        explanation: "Смайлики - это юникоды. Юникод для сердца - 'U+2764 U+FE0F'. Юникоды одинаковы для одних и тех же смайликов. Таким образом, мы сравниваем две одинаковые строки, поэтому возвращается 'true'."
    },
    {
        id: 94,
    ...
    },
    {
        ...
        correct: 2,
        explanation: "С помощью spread-оператора ('...') мы разбиваем итерируемые сущности на отдельные элементы. Функция 'sumValues' принимает три аргумента: 'x, y и z'. Для того, чтобы эта функция вернула '6', ей в качестве аргумента необходимо передать '...[1, 2, 3]'."
    },
    {
        id: 100,
        ...
        correct: 1,
        explanation: "С помощью оператора '+=' мы увеличиваем значение переменной 'num' на '1'. Начальным значением 'num' является '1', выражение '1 + 1' оценивается как '2'. Элементом массива со вторым индексом является 'c', что и выводится в консоль."
    },
    {
        id: 101,
    ...
    },
    {
        ...
        correct: 1,
        explanation: "Условие 'groceries.indexOf('banana')' возвращает значение '0', которое является ложным. Поскольку условие не удовлетворяется, выполняется код в блоке 'else', в консоль выводится 'Нам не нужно покупать бананы!'"
    },
    {
        id: 103,
        ...
        correct: 3,
        explanation: "Метод 'language' - это сеттер. Сеттеры не имеют собственных значений, их задача - модифицировать свойства объекта. Поэтому вызов сеттера возвращает 'undefined'."
    },
    {
        id: 104,
        ...
        correct: 2,
        explanation: "Выражение 'typeof name' возвращает 'string'. 'string' - это истинное значение, поэтому выражение '!typeof name' возвращает 'false'. 'false === 'object'' и 'false === 'string'' возвращают 'false' (если мы хотим сравнить типы значений вместо '!typeof' следует использовать '!==')."
    },
    {
        id: 105,
    ...
    },
    {
        ...
        correct: 3,
        explanation: "Функция 'myFunc' в качестве аргумента ожидает получить объект со свойствами 'x, y и z'. Поскольку мы передаем ей '1, 2, 3', а не '{ x: 1, y: 2, z: 3 }', то возвращается значение 'x, y и z' по умолчанию, т.е. 'undefined'."
    },
    {
        id: 108,
        ...
        correct: 1,
        explanation: "Деструктурируя объекты, мы распаковываем значения правого объекта и присваиваем их одноименному свойству левого объекта. В данном случае мы присваиваем значение '💀' 'spookyItems[3]'. Это означает, что мы модифицируем массив 'spookyItems', добавляя в него '💀'. Поэтому получаем '['👻', '🎃', '👿', '💀']'."
    },
    {
        id: 109,
    ...
    },
    {
        ...
        correct: 2,
        explanation: "В блоке 'try' мы выводим в консоль ожидаемое (разрешенное) значение переменной 'myPromise' - 'Woah some cool data'. Поскольку в блоке 'try' не возникло ошибки, код в блоке 'catch' не выполняется. Код в блоке 'finally' выполняется всегда, поэтому в консоль выводится 'Oh finally'."
    },
    {
        id: 112,
        ...
        correct: 1,
        explanation: "С помощью метода 'flat' мы создаем новый 'плоский' массив. Глубина этого массива зависит от передаваемого значения. В данном случае мы передаем значение '1' (чего мы могли бы не делать, поскольку оно является значением по умолчанию), значит, будут объединены только массивы первого уровня вложенности, т.е. '['💫']' и '['✨', '✨', ['🍕', '🍕']]'. Результатом объединения этих массивов является '['💫', '✨', '✨', ['🍕', '🍕']]'."
    },
    {
        id: 113,
    ...
    },
    {
        ...
        correct: 0,
        explanation: "Сначала мы вызываем функцию 'myFunc' без аргументов. Поэтому аргументам присваиваются значения по умолчанию: 'num' - '2', а 'value' - значение, возвращаемое функцией 'add'. Мы передаем 'add()' значение 'num' в качестве аргумента, которое равняется '2'. 'add()' возвращает '4', что является значением 'value'. Затем мы вызываем 'myFunc()' с аргументом '3', которое присваивается 'num'. Поскольку мы не присваиваем значения 'value', его значением вновь становится значение, возвращаемое 'add()'. Мы передаем 'add()' значение '3', она возвращает '6', что становится значением 'value'."
    },
    {
        id: 119,
        ...
        correct: 3,
        explanation: "В 'ECMAScript 2020' мы можем добавлять классам приватные (частные/закрытые) переменные с помощью символа '#'. Мы не можем получить доступ к таким переменным за пределами класса. Поэтому, когда мы пытается вывести в консоль значение 'counter.#number', выбрасывается исключение 'SyntaxError'."
    },
    {
        id: 120,
    ...
    },
    {
        ...
        correct: 1,
        explanation: "Мы создаем переменную 'pet', которая является экземпляром класса 'Flamingo'. При создании экземпляра вызывается 'constructor()'. В консоль выводится 'I'm pink. 🌸', после чего вызывается 'super()'. 'super()' вызывает конструктор родительского класса. В консоль выводится 'I'm a bird. 🐤'."
    },
    {
        id: 123,
    ...
    },
    {
        ...
        correct: 1,
        explanation: "Функция 'updateUser' обновляет свойства 'email' и 'password' объекта 'user', если их значения переданы в качестве аргументов, после чего функция возвращает объект 'user'. Значением, которое вернула 'updateUser()', является объект 'user'. Таким образом, переменная 'updatedUser' ссылается на то же место в памяти, что и сам 'user'. Поэтому выражение 'updatedUser === user' возвращает 'true'."
    },
    {
        id: 128,
        ...
        correct: 2,
        explanation: "Сначала мы вызываем метод 'slice' для массива 'fruits'. Данный метод не модифицирует исходный массив и возвращает извлеченное значение: '🍌'. Затем мы вызываем метод 'splice'. Данный метод модифицирует исходный массив, 'fruits' теперь выглядит так: '['🍊', '🍎']'. Наконец, мы вызываем метод 'unshift', который также модифицирует исходный массив, добавляя к нему '🍇' в качестве первого элемента. Массив 'fruits' теперь выглядит так: '['🍇', '🍊', '🍎']'."
    },
    {
        id: 129,
    ...
    },
    {
        ...
        correct: 0,
        explanation: "Функция 'updateEmail' является стрелочной, поэтому она не привязана (bind) к объекту 'user'. Это означает, что ключевое слово 'this' не ссылается на объект 'user'. В данном случае 'this' указывает на глобальную область видимости ('window' в браузере, 'global' в 'Node.js'). Значение свойства 'email' объекта 'user' не обновляется. Поэтому, когда мы обращаемся к 'user.email', в консоль выводится 'my@email.com'."
    },
    {
        id: 131,
    ...
    },
    {
        ...
        correct: 2,
        explanation: "Значением 'address' по умолчанию является пустой объект ('{}'). Когда мы присваиваем переменной 'member' значение, возвращаемое функцией 'createMember', мы не передаем значение для 'address', поэтому ее значением становится '{}'. Пустой объект - это истинное значение, поэтому условие 'address ? address : null' возвращает 'address'. Значением 'address' является '{}'."
    },
    {
        id: 134,
    ...
    },
    {
        ...
        correct: 3,
        explanation: "Объявление функции поднимается в начало области видимости подобно объявлению переменной. Это называется поднятием или подъемом (hoisting). Поэтому место объявления функции 'Venicle' в данном случае значения не имеет."
    },
    {
        id: 136,
        ...
        correct: 2,
        explanation: "Функция 'foo' возвращает '1' из-за оператора '++'. Выражение 'let x = y = 0' определяет локальную переменную 'x'. Однако 'y' определяется как глобальная переменная. Данное выражение эквивалентно следующему:\n'''js\nlet x\nwindow.y = 0\nx = window.y\n'''\nПоскольку переменная 'x' за пределами функции имеет значение 'undefined', т.е. не определена, ее типом также является 'undefined'. Однако 'y' за пределами функции доступна и имеет значение '0' с типом 'number'."
    },
    {
        id: 137,
    ...
    },
    {
        ...
        correct: 0,
        explanation: "Здесь мы имеем дело с распространенной проблемой чисел с плавающей точкой (или запятой, или чисел двойной точности, см. 'IEEE 754'). Поскольку такие числа преобразуются в двоичные данные, имеет место некоторая неточность округления. Поэтому математические операции с названными числами порой приводят к неожиданным результатам. В частности, значением выражения '0.1 + 0.2' будет '0.30000000000000004', что чуть больше, чем '0.3'. Поэтому сравнение '0.1 + 0.2 === 0.3' возвращает 'false'."
    },
    {
        id: 139,
        question: "var y = 1\nif (function f(){}) {\n  y += typeof f\n}\nconsole.log(y)",
        ...
        correct: 3,
        explanation: "Условие 'if (function f(){})' возвращает 'true' (функция - это объект). Поскольку переменная 'f' нигде не определяется, она имеет значение 'undefined' по умолчанию с типом 'undefined'. Получаем '1 + undefined' или '1undefined' (оба операнда приводятся к строке)."
    },
    {
        id: 140,
        question: "function foo() {\nreturn\n  {\n    message: 'Hello World'\n  }\n}\nconsole.log(foo())",
        ...
        correct: 2,
        explanation: "Здесь мы имеем дело с автоматической расстановкой точек с запятой движком 'JavaScript'. В данном случае точка с запятой автоматически вставляется после оператора 'return'. Поэтому функция возвращает 'undefined'.\nЕсли поставить '{' перед 'return', то функция будет работать, как ожидается:\n'''js\nfunction foo() { return { message: 'Hello World' } }\nconsole.log(foo()) // { message: 'Hello World' }\n'''"
    },
    {
        id: 141,
        ...
        correct: 2,
        explanation: "Оператор 'delete' удаляет свойства объекта, но не индексы массива. Точнее, удаляется только значение массива по указанному индексу, сам индекс остается, его значением становится 'undefined'. При этом, количество элементов в массиве и его длина сохраняются."
    },
    {
        id: 142,
        ...
        correct: 0,
        explanation: "'ES6', среди прочего, представил новые способы определения методов и сокращения свойств объекта. Поэтому 'prop2' и 'prop3' обрабатываются как обычные функции."
    },
    {
        id: 143,
        ...
        correct: 1,
        explanation: "Если в блоке 'if' содержатся одинаковые операторы, то выражение оценивается слева направо. Для первого выражения порядок будет следующим:\n'''js\nconsole.log(1 < 2 < 3)\nconsole.log(true < 3)\nconsole.log(1 < 3) // true\n'''\nА для второго таким:\n'''js\nconsole.log(3 > 2 > 1)\nconsole.log(true > 1)\nconsole.log(1 > 1) // false\n'''"
    },
    {
        id: 144,
    ...
    },
    {
        ...
        correct: 2,
        explanation: "В отличие от обычных, в стрелочных функциях дублирующиеся параметры запрещены, независимо от режима выполнения кода. Поэтому в данном случае будет выброшено исключение 'SyntaxError: Duplicate parameter name not allowed in this context' (дублирующиеся названия параметров в данном контексте запрещены)."
    },
    {
        id: 146,
        ...
        correct: 0,
        explanation: "Стрелочные функции не имеют 'arguments', 'this', 'super' и 'new.target'. Поэтому любое обращение к 'arguments' приводит к поиску переменной с таким названием в лексическом (внешнем) окружении функции. В данном случае переменной 'arguments' в коде не существует. Поэтому возникает Error.\nВ обычных функциях 'arguments' - это массивоподобный объект, содержащий переданные функции аргументы:\n'''js\nconst f = function () { return arguments.length }\nconsole.log(f(1, 2, 3)) // 3\n'''\nВ стрелочных функциях альтернативой 'arguments' является rest-оператор '...' (прочие параметры):\n'''js\nconst f = (...args) => args.length\nconsole.log(f(1, 2, 3)) // 3\n'''"
    },
    {
        id: 147,
        ...
        correct: 1,
        explanation: "По аналогии с 'String.prototype.padStart' встроенный метод для удаления пробелов в начале строки был назван 'trimStart'. Однако для обеспечения обратной совместимости название 'trimLeft' было сохранено в качестве синонима (alias) для 'trimStart'. При этом, прототипом 'trimLeft' является 'trimStart'."
    },
    {
        id: 148,
        ...
        correct: 3,
        explanation: "'-Infinity' - это наименьшее из сравниваемых значений, поскольку почти любое другое значение в 'JavaScript' больше него. Поэтому, когда 'Math.max()' вызывается без аргументов, возвращается '-Infinity'."
    },
    {
        id: 149,
        ...
        correct: 0,
        explanation: "Согласно спецификации 'ECMAScript' приведенные выражения будут преобразованы следующим образом:\n'''js\n10 == Number([10].valueOf().toString()) // 10\n'''\nПоэтому количество скобок значения не имеет."
    },
    {
        id: 150,
        question: "console.log(10 + '10')\nconsole.log(10 - '10')",
        ...
        correct: 1,
        explanation: "Оператор '+' применяется как к числам, так и к строкам. Если одним из операндов является строка, второй операнд также приводится к строке, и операнды объединяются. Это называется конкатенацией. Оператор '-' пытается преобразовать операнд в число. При невозможности это сделать возвращается 'NaN'."
    },
    {
        id: 151,
        ...
        correct: 3,
        explanation: "Оператор '+' не предназначен для сложения массивов. Поэтому массивы преобразуются в строки и объединяются."
    },
    {
        id: 152,
        ...
        correct: 0,
        explanation: "'Set' - это объект, представляющий собой коллекцию уникальных значений, поэтому повторяющиеся значения в него не включаются. В то же время, данный объект является чувствительным к регистру, поэтому в коллекцию записываются как 'F', так и 'f'."
    },
    {
        id: 153,
    ...
    },
    {
        ...
        correct: 2,
        explanation: "При использовании rest-оператора '...' (прочие параметры), он передается в качестве последнего аргумента. В данном случае использование замыкающей запятой (trailing comma) приводит к возникновению ошибки. Если убрать запятую, то все будет в порядке:\n'''js\nconst [a, ...b] = [1, 2, 3, 4, 5]\nconsole.log(a, b) // 1 [2, 3, 4, 5]\n'''"
    },
    {
        id: 156,
    ...
    },
    {
        ...
        correct: 3,
        explanation: "'await' возвращает 'Promise {:10}', который может быть обработан с помощью 'then'. В данном случае функция не содержит оператора 'return', т.е. не возвращает никакого значение в явном виде. Поэтому возвращается 'undefined'. Приведенный код эквивалентен следующему:\n'''js\nfunction func () { return Promise.resolve(10).then(() => undefined) }\n'''"
    },
    {
        id: 158,
    ...
    },
    {
        ...
        correct: 3,
        explanation: "Метод 'forEach' не ожидает завершения операции, он лишь запускает ее выполнение и двигается дальше. Поэтому 'console.log('Process finished!')' выполняется первым согласно последовательности разрешения промисов. Определить нужную последовательность можно с помощью оператора 'for-of' и ключевого слова 'await':\n'''js\nasync function processArray(array) {\n  for (const item of array) {\n    await delayedLog(item)\n  }\n  console.log('Process completed!')\n}\n'''"
    },
    {
        id: 160,
        ...
        correct: 0,
        explanation: "В отличии от операторов равенства ('==' и '==='), для 'Set' все 'NaN' являются одинаковыми значениями, а '+0' и '-0' - разными."
    },
    {
        id: 161,
    ...
    },
    {
        ...
        correct: 0,
        explanation: "'Symbol' - это обычная функция, а не конструктор, в отличие, например, от 'Number' или 'String'. Поэтому при попытке использования его с ключевым словом 'new' выбрасывается исключение 'TypeError: Symbol is not a constructor' ('Symbol' не является конструктором)."
    },
    {
        id: 163,
        ...
        correct: 3,
        explanation: "Оператор '!' приводит значение к логическому типу и инвертирует его. Поскольку выражения 'typeof myNumber' и 'typeof myString' истинные, в обоих случаях возвращается 'false'. Далее выполняются блоки 'else'."
    },
    {
        id: 164,
        ...
        correct: 1,
        explanation: "'undefined', функции и символы не являются валидными 'JSON-значениями'. Такие значения не включаются в объект и конвертируются (преобразуются) в 'null'. Поэтому возвращается 'null, null, null'. Глобальные символы игнорируются, поэтому возвращается пустой объект ('{}')."
    },
    {
        id: 165,
        ...
        correct: 1,
        explanation: "'new.target' ссылается на конструктор (указывает на класс), который вызывается с помощью ключевого слова 'new'. Это также справедливо для конструктора родительского класса, вызываемого из подкласса."
    },
    {
        id: 166,
    ...
    },
    {
        ...
        correct: 0,
        explanation: "Деструктуризацию массива и объекта можно комбинировать. В данном случае переменной 'name' присваивается значение соответствующего свойства третьего элемента массива 'props'."
    },
    {
        id: 169,
        ...
        correct: 2,
        explanation: "Если функции не передается значение или передается 'undefined', аргумент принимает значение по умолчанию ('1'). Другие ложные значения ('''' и 'null') присваиваются аргументу.\nПервые два вызова функции 'checkType' возвращают 'number', поскольку значением аргумента является '1'.\nТипом пустой строки ('''') является 'string', а типом 'null' - 'object'."
    },
    {
        id: 170,
        ...
        correct: 1,
        explanation: "Аргументу 'items' при каждом вызове функции 'add' присваивается пустой массив (значение по умолчанию), который возвращается с помещенным в него значением аргумента 'item'."
    },
    {
        id: 171,
        ...
        correct: 1,
        explanation: "При первом вызове функции 'greet' аргументу 'message' присваивается значение по умолчанию ('greeting + ' ' + name'). При втором вызове данному аргументу присваивается переданное значение ('Good morning!')."
    },
    {
        id: 172,
        ...
        correct: 0,
        explanation: "Функции и переменные, объявленные в теле функции, не могут использоваться в качестве значений по умолчанию, поэтому выбрасывается исключение 'ReferenceError: inner is not defined' (переменная 'inner' не определена). Для того, чтобы сделать функцию работоспособной, ее можно переписать так:\n'''js\nfunction outer (f) { function inner () { return 'Inner' }; const fun = f || inner(); return fun }\nconsole.log(outer()) // Inner\nconsole.log(outer('Outer')) // Outer\nИли так:\nconst outer = (msg = 'Inner') => msg\nconsole.log(outer()) // Inner\nconsole.log(outer('Outer')) // Outer\n'''"
    },
    {
        id: 173,
        ...
        correct: 2,
        explanation: "Оператор rest (прочие параметры, '...') возвращает массив с переданными функции неименованными аргументами или пустой массив в случае, когда такие аргументы отсутствуют."
    },
    {
        id: 174,
        ...
        correct: 1,
        explanation: "Оператор spread (распространения или распаковки, '...') применяется только к итерируемым (перебираемым) сущностям. Объекты таковыми не являются. Поэтому выбрасывается исключение 'TypeError: object is not iterable' (объекты не являются итерируемыми сущностями)."
    },
    {
        id: 175,
        ...
        correct: 3,
        explanation: "Генераторы (функции со специальным символом '*' после названия) не могут использоваться в качестве конструкторов, т.е. с ключевым словом 'new', поэтому выбрасывается исключение 'TypeError: myGenFunc is not a constructor' ('myGenFunc' не является конструктором)."
    },
    {
        id: 176,
        ...
        correct: 0,
        explanation: "Инструкция 'return' в генераторе (функция со специальным символом '*' после названия) останавливает его выполнение. Возвращаемое значение '2' присваивается свойству 'value', а значением свойства 'done' становится 'true'. После завершения работы генератора вызов метода 'next' возвращает '{ value: undefined, done: true }'."
    },
    {
        id: 177,
        ...
        correct: 3,
        explanation: "Генератор (функция со специальным символом '*' после названия) не может использоваться после закрытия итератора. В первом цикле мы с помощью оператора 'break' останавливаем выполнение генератора со значением '1'. Повторный перебор генератора невозможен, поэтому второй 'console.log()' ничего не выводит в консоль."
    },
    {
        id: 178,
    ...
    },
    {
        ...
        correct: 3,
        explanation: "Когда обычный метод или метод прототипа вызывается без передачи ему значения 'this', метод возвращает значение 'this' по умолчанию. В данном случае таким значением является глобальный объект ('window' в браузере, 'global' в 'Node.js')."
    },
    {
        id: 180,
        ...
        correct: 2,
        explanation: "Ключевое слово 'super' используется, в том числе, для вызова методов родительского класса. В отличие от других языков программирования, в 'JavaScript' вызов 'super()' не обязательно должен быть первой инструкцией."
    },
    {
        id: 181,
    ...
    },
    {
        ...
        correct: 0,
        explanation: "'Object.assign(candidate, job)' объединяет 'candidate' и 'job' в один объект. Затем 'Object.keys()' возвращает массив ключей объекта. Обратите внимание, что методы 'get' и 'count' определены как статические, поэтому их можно вызывать с помощью 'Class.staticMethodName()'. Результирующий объект содержит '5' ключей."
    },
    {
        id: 189,
        question: "var x = 1\n\n;(() => {\n  x += 1\n  ++x\n})()\n\n;((y) => {\n  x += y\n  x = x % y\n})(2)\n\n;(() => (x += x))()\n\n;(() => (x *= x))()\n\nconsole.log(x)",
    ...
    },
    {
        ...
        correct: 3,
        explanation: "Технически 'x' и 'y' имеют одинаковые значения. Обе переменные являются пустыми объектами. Однако объекты сравниваются не по значениям. 'z' и 'x' являются объектами, ссылающимися на одно и то же место в памяти. В 'JavaScript' объекты передаются по ссылкам. Поэтому при сравнении 'x' и 'z' возвращается 'true'."
    },
    {
        id: 191,
    ...
    },
    {
        ...
        correct: 2,
        explanation: "Данная задача показывает, как работает оператор 'delete'. Выражения 'delete someObject' и 'delete someArray' возвращают 'false' (ничего не делают). Выражение 'delete someObject.someProperty' удаляет указанное свойство объекта. В случае с массивом, выражение 'delete someArray[keyNumber]' удаляет только значение указанного индекса, сам индекс остается и его новым значением становится 'undefined'. По этой причине первый 'console.log()' выводит '4' (массив содержит '4' элемента, последний имеет значение 'undefined'), а второй - '3' (количество оставшихся свойств объекта). Последний 'console.log()' выводит '4', поскольку присвоение свойству объекта значения 'null' или 'undefined' не удаляет это свойство, ключ остается. Поэтому длина массива ключей объекта сохраняется."
    },
    {
        id: 195,
    ...
    },
    {
        ...
        correct: 3,
        explanation: "'Object.keys(obj)' почти идентичен 'Object.getOwnPropertyNames(obj)', за исключением того, что последний, кроме перечисляемых, возвращает также неперечисляемые ключи объекта. По умолчанию все свойства создаваемого объекта являются перечисляемыми. Мы можем сделать их неперечисляемыми с помощью 'Object.defineProperty()' или 'Object.defineProperties()' (настройка 'enumerable: false'). Поэтому 'Object.keys(person)' возвращает '3', а 'Object.getOwnPropertyNames(person)' - '4'. Тернарный оператор возвращает '4'."
    },
    {
        id: 198,
        ...
        correct: 3,
        explanation: "Когда мы определяем одну функцию внутри другой, то получаем замыкание (closure). Обратите внимание, если функция обычная (а не функциональное выражение), она поднимается в начало области видимости. Мы видим несколько 'id' в коде, но некоторые из них ничего не делают. Результатом выполнения кода является 'typeof id', т.е. 'function'. Таким образом, 'id' в рассматриваемом примере является функцией."
    },
    {
        id: 199,
        ...
        correct: 0,
        explanation: "'Object.create()' позволяет создавать одни объекты на основе других. Если мы не передадим второй параметр - 'book2', в данном случае - свойство 'name' объекта 'bookCollection' будет иметь значение 'Name of the Rose', унаследованное от 'book1'. Это означает, что мы можем добавлять новые свойства создаваемому с помощью 'Object.create()' объекту. 'bookCollection' имеет собственное свойство 'name' и одноименное свойство, унаследованное от 'book1'. Собственные свойства объекта имеют приоритет над унаследованными. Поэтому мы получаем 'Harry Potter'."
    },
    {
        id: 200,
        ...
        correct: 3,
        explanation: "Объекты 'a' и 'b' создаются с помощью 'Object.create()'. Разница между ними состоит в том, что 'a' наследует прототип 'Object', а 'b' является совершенно пустым, поскольку мы передали аргумент 'null' методу 'create'. 'hasOwnProperty('toString')' в обоих случаях возвращает 'false', поскольку в объектах метод 'toString' не определен. Однако данный метод существует в объекте 'a' как унаследованный от 'Object'. 'f1' и 'f2' возвращают 'false'. Обратите внимание, что для проверки наличия свойства в объекте мы используем 'Object.hasOwnProperty('key')' и '('key' in object)'. Они отличаются тем, что первый возвращает только собственные свойства объекта, а второй - также унаследованные. 'typeof a.toString()' возвращает 'string', длина которой равняется '6'."
    },
    {
        id: 201,
    ...
    },
    {
        ...
        correct: 2,
        explanation: "У нас имеется класс 'Calculator'. При создании нового экземпляра, мы передаем ему два аргумента: 'a' и 'b'. Эти аргументы имеют одинаковые значения, но 'new Array(this.a).length' сильно отличается от 'new Array(this.b).toString().length', поскольку последний возвращает длину строки ',,,,', или '4', а первый - длину массива, или '5'. По этой причине 'getFlags()' возвращает 'false'. В 'getValue()' мы получаем выражение 'typeof new Number(this.b)', что возвращает 'object'. Это немного отличается от выражения 'typeof b', которое возвращает 'number'."
    },
    {
        id: 207,
    ...
    },
    {
        ...
        correct: 3,
        explanation: "'...' в массиве - это spread-оператор (оператор распространения/распаковки), который похож на rest-оператор (прочие параметры). Данный оператор позволяет объединять (изменять) и копировать массивы. В рассматриваемом примере 'b' - это копия 'a'. Тем не менее, когда мы передаем 'a' в 'Set', возвращаются только уникальные значения. Это означает, что 'b' содержит '[1, 2, 'one', 3, 'two']'. Затем мы устанавливаем значение длины 'b' равным '3' (''one'.length'). Таким образом, мы уменьшили длину массива. Вот почему в консоль выводится только '[1, 2, 'one']'."
    },
    {
        id: 215,
    ...
    },
    {
        ...
        correct: 1,
        explanation: "'getString' - это стрелочная функция с двумя параметрами. Как видите, параметр 'method' имеет значение по умолчанию, равное 'false'. Если не передать другое значение при вызове функции или передать 'undefined', будет использовано значение по умолчанию.\nОсновной вывод: разница между 'slice(1, 4)', возвращающим '3', и 'substr(1, 4)', возвращающим '4'.\n'console.log(getString('hello', true) + getString('hello'))' или 'console.log(string.substr(1, 4).length + string.slice(1, 4).length)', или 'console.log(4 + 3)' выводит в консоль '7'."
    },
    {
        id: 223,
    ...
    },
    {
        ...
        correct: 1,
        explanation: "У нас имеется самовызывающаяся функция (IIFE) с пустым массивом в качестве аргумента. Обратите внимание, что сравнение 'NaN === NaN' возвращает 'false', поэтому переменная 'age' получает значение 'flag', т.е. пустой массив.\n'Boolean([])' возвращает 'true'.\nФункция 'toString' возвращает строку 'true', а 'Number([])' - '0'. Поэтому в консоль выводится 't'.\nОбратите внимание, что 'Boolean([]) === true', но 'Number([]) === 0', а 'NaN === NaN' возвращает 'false'."
    },
    {
        id: 226,
